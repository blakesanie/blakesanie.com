...
image: /public/assets/posts/newyear/diagram.png
publish: true
---
...
<InlineImg src="/public/assets/posts/newyear/diagram.png" alt="Illustration of hypothesis"/>
...
<InlineImg src="/public/assets/posts/newyear/circle.png" alt="Component breakdown of radius"/>
...
<div class="allInline">
Fundamentally, there exists a circle of radius of radius $r > 0$, and its center can be found by $r^2 + \frac{1}{4}$. The circle with $r = 0$ is excluded from the domain since it constructs a point. By the way, notice anything special about the constant $\frac{1}{4}$? It's the focus of the standard parabola!
</div>
...
<InlineImg src="/public/assets/posts/newyear/desmos.png" alt="Final visualization of inscribed circles in standard parabola"/>
