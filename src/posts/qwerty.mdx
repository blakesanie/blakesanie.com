...
image: /src/assets/images/posts/qwerty/qwerty.jpg
publish: true
---
import InlineImg from "../components/basic/InlineImg.astro";

<InlineImg src="/src/assets/images/posts/qwerty/qwerty.jpg"/>
...
<InlineImg src="/src/assets/images/posts/qwerty/row.gif" alt="The home row"/>
...
['c','w','b','m','f','g','l','d','u','y']['n','h','r','o','i','s','e','t','a']
['v','q','j','k','x','z','p']
```
