...
image: /public/assets/posts/qwerty/qwerty.jpg
publish: true
---
import InlineImg from "../components/basic/InlineImg.astro";

<InlineImg src="/public/assets/posts/qwerty/qwerty.jpg"/>
...
<InlineImg src="/public/assets/posts/qwerty/row.gif" alt="The home row"/>
